...
CUDA_VISIBLE_DEVICES=$GPU_ID  python3  run_acener.py  --model_type bertspanmarker  \
    ...
    --output_dir radgraph_models/PL-Marker-radgraph-scibert-ner-$seed  --overwrite_output_dir  --output_results
done;

touch radgraph_models/run_train_ner_radgraph_scibert_done
