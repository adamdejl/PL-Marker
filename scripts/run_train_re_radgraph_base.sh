...
CUDA_VISIBLE_DEVICES=$GPU_ID  python3  run_re.py  --model_type bertsub  \
    ...
    --max_seq_length 256  --max_pair_length 32  --save_steps 200  \
    --do_train  --do_eval  --evaluate_during_training   --eval_all_checkpoints  --eval_logsoftmax  \
    --fp16  --seed $seed    \
    --train_file train.json --dev_file dev.json --test_file test.json  \
    --output_dir radgraph_models/PL-Marker-radgraph-base-re-$seed  --overwrite_output_dir
done;

touch radgraph_models/run_train_re_radgraph_base_done
